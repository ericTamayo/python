...
class KA3005P:
	...
	##################################################
	def ON(self):
		self.Output_Print("Enabling Powersupply...")
		self.COMMAND("OUT1")
		sleep(3)
		self.Output_Print("\tPowersupply Enabled")
		#if(DEBUG):
	...
	def SET_VOLTAGE(self,value):
		self.Output_Print("Set Voltage:" + str(value) + "V")
		self.OFF()
	...
	def SET_CURRENT(self,value):
		self.Output_Print("Set Current:" + str(value) + "A")
		self.OFF()
